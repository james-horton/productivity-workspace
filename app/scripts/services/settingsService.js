...
/**
 * @typedef {{ theme: string, openaiModel: 'gpt-5.6-sol' | 'gpt-6-astra', city: string, state: string, subreddits: string[], showInspirationQuote: boolean, showCalculator: boolean, showClock: boolean, clockView: 'digital' | 'analog-marks' | 'analog-quarters' | 'analog-numerals' | 'analog-roman-numerals', showAnalogClockFrame: boolean, analogClockFrameWidth: number, showWebSearch: boolean, showNews: boolean, showAgent: boolean, showReddit: boolean, roundedBorders: boolean }} UserSettings
 */
