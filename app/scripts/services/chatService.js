 ...
 * @param {'none'|'low'|'medium'|'high'|'xhigh'} [opts.reasoning] OpenAI reasoning effort. Only honored by the server when mode === 'basic'. For other modes the server always uses its fixed per-mode reasoning value.
